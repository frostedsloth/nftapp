...
import { Spinner, Navbar, Nav, NavDropdown, Button, Container } from 'react-bootstrap'
      ...
      <div className="App">
        <>
          <Navbar expand="lg" bg="dark" variant="dark">
            <Container>
            <Navbar.Brand href="#">Jeeyanavi</Navbar.Brand>
              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="me-auto">
                  ...
                  <NavDropdown title="Artist Playlists" id="collasible-nav-dropdown">
              <NavDropdown.Item href="#">Artist 1</NavDropdown.Item>
              <NavDropdown.Item href="#">Artist 2</NavDropdown.Item>
              <NavDropdown.Item href="#">Artist 3</NavDropdown.Item>
            </NavDropdown>
                </Nav>
                <Nav>
                  {account ? (
